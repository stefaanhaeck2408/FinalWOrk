  ...
  render() {
    return (
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to MakeAQuiz.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to MakeAQuiz, accessible from{" "}
              <a
                href="https://makeaquiz.azurewebsites.net/"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://makeaquiz.azurewebsites.net/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: stefaan.haeck@student.ehb.be</li>
        </ul>
        ...
        <p>
          ...
          https://makeaquiz.azurewebsites.net/, you are agreeing to be bound by
        ...
        <p>
          ...
          materials on MakeAQuiz's Website for personal, non-commercial
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on MakeAQuiz's
            Website;
          </li>
          <li>
        ...
        <p>
          This will let MakeAQuiz to terminate upon violations of any of these
        ...
        <p>
          All the materials on MakeAQuiz’s Website are provided "as is".
          MakeAQuiz makes no warranties, may it be expressed or implied,
          therefore negates all other warranties. Furthermore, MakeAQuiz does
        ...
        <p>
          MakeAQuiz or its suppliers will not be hold accountable for any
          damages that will arise with the use or inability to use the materials
          on MakeAQuiz’s Website, even if MakeAQuiz or an authorize
        ...
        <p>
          The materials appearing on MakeAQuiz’s Website may include technical,
          typographical, or photographic errors. MakeAQuiz will not promise that
          any of the materials in this Website are accurate, complete, or
          current. MakeAQuiz may change the materials contained on its Website
          at any time without notice. MakeAQuiz does not make any commitment to
        ...
        <p>
          MakeAQuiz has not reviewed all of the sites linked to its Website and
          is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by MakeAQuiz of the
        ...
        <p>
          MakeAQuiz may revise these Terms of Use for its Website at any time
        ...
        <p>
          Any claim related to MakeAQuiz's Website shall be governed by the laws
          of be without regards to its conflict of law provisions.
        </p>
      </div>
    );
  }
